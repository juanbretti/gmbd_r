...
```{r}
data_solar_col_produ_scores <- lapply(data_solar_col_produ, function(x) scores(data_solar_train[[x]], type = 'z'))
names(data_solar_col_produ_scores) <- data_solar_col_produ
skim(data_solar_col_produ_scores)

# summary(unlist(data_solar_col_produ_scores))
hist(unlist(data_solar_col_produ_scores))

table(
  abs(unlist(data_solar_col_produ_scores))>=3
)
```
