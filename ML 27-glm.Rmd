...
model_train <- function(cluster, num_col_importance, num_lag, num_times) {
  ...
  # Model training
  model <- glm(Cluster ~ ., data = data_train)
  # Results
...
# str(model_trained)
saveRDS(model_trained, file.path('storage', 'model_trained_27_glm.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained_27_glm.rds'))
...
saveRDS(model_applied, file.path('storage', 'model_applied_27_glm.rds'))
# model_applied <- readRDS(file.path('storage', 'model_applied_27_glm.rds'))
...
saveRDS(out, file.path('storage', 'out_27_xgb.rds'))
# out <- readRDS(file.path('storage', 'out_27_xgb.rds'))
