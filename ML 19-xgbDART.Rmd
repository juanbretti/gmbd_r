...
# saveRDS(model_trained, file.path('storage', 'model_trained19_xgbDART.rds'))
model_trained <- readRDS(file.path('storage', 'model_trained19_xgbDART.rds'))
...
# saveRDS(model_applied, file.path('storage', 'model_applied19_xgb.rds'))
model_applied <- readRDS(file.path('storage', 'model_applied19_xgb.rds'))
