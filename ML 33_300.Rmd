...
saveRDS(data_col_importance, file.path('storage', 'data_col_importance_lag_33_300.rds'))
...
saveRDS(model_trained, file.path('storage', 'model_trained_33_300.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained_33_300.rds'))
...
saveRDS(out, file.path('storage', 'out_33_300.rds'))
# out <- readRDS(file.path('storage', 'out_33_300.rds'))
