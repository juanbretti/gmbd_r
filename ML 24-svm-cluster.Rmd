...
# model_trained[[cluster_name(2)]]$trained


# str(model_trained)
saveRDS(model_trained, file.path('storage', 'model_trained_24_svm.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained_24_svm.rds'))
...
saveRDS(model_applied, file.path('storage', 'model_applied_24_svm.rds'))
# model_applied <- readRDS(file.path('storage', 'model_applied_24_svm.rds'))
...
saveRDS(out, file.path('storage', 'out_24_xgb.rds'))
# out <- readRDS(file.path('storage', 'out_24_xgb.rds'))
