...
# str(model_trained)
saveRDS(model_trained, file.path('storage', 'model_trained_30_h2o-glm.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained_30_h2o-glm.rds'))
...
saveRDS(model_applied, file.path('storage', 'model_applied_30_h2o-glm.rds'))
# model_applied <- readRDS(file.path('storage', 'model_applied_30_h2o-glm.rds'))
...
predict_fun <- function(data, row_to_predict, cluster) {
  ...
  pre_ <- predict(object = model_trained[[cluster_name(cluster)]]$pre_process, newdata = data_predict)
  value_predicted <- predict(object = model_trained[[cluster_name(cluster)]]$model, newdata = pre_)
...
saveRDS(out, file.path('storage', 'out_30_h2o-glm.rds'))
# out <- readRDS(file.path('storage', 'out_30_h2o-glm.rds'))
