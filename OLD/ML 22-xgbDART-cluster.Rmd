...
system.time({
  model_trained <- lapply(1:num_clusters, model_train, num_col_importance, num_lag, num_times)
})
...
system.time({
  model_applied <- lapply(1:num_clusters, model_apply, num_col_importance, num_lag, num_times)
})
