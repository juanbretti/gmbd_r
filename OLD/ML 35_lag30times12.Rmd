...
saveRDS(data_col_importance, file.path('storage', 'data_col_importance_lag_35_lag30times12.rds'))
# data_col_importance <- readRDS(file.path('storage', 'data_col_importance_lag_35_lag30times12.rds'))
...
saveRDS(model_trained, file.path('storage', 'model_trained_35_lag30times12.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained_35_lag30times12.rds'))
...
saveRDS(out, file.path('storage', 'out_35_lag30times12.rds'))
# out <- readRDS(file.path('storage', 'out_35_lag30times12.rds'))
