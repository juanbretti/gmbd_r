...
data_solar_add_train <- data_solar_add_train_[index_train, ]
data_solar_add_val <- data_solar_add_train_[index_val, ]
...
# str(model_trained)
# saveRDS(model_trained, file.path('storage', 'model_trained_31_index.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained_31_index.rds'))
...
saveRDS(out, file.path('storage', 'out_31_index.rds'))
# out <- readRDS(file.path('storage', 'out_31_index.rds'))
