...
# str(model_trained)
# saveRDS(model_trained, file.path('storage', 'model_trained_32_300.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained_32_300.rds'))
...
saveRDS(out, file.path('storage', 'out_32_300.rds'))
# out <- readRDS(file.path('storage', 'out_32_300.rds'))
