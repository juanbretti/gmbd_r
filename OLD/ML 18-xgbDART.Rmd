...
model_trained <- readRDS(file.path('storage', 'model_trained18_xgbDART.rds'))
...
saveRDS(model_applied, file.path('storage', 'model_applied17_xgb.rds'))
# model_applied <- readRDS(file.path('storage', 'model_applied17_xgb.rds'))
