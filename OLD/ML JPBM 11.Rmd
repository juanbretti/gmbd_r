...
model_train <- function(WeatherStation, col_importance_number = 40) {
  ...
  # Grid search
  tuneControl <- expand.grid(C = 10^seq(from = -2, to = 1, by = 0.5),
...
saveRDS(model_trained, file.path('storage', 'model_trained3.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained3.rds'))
