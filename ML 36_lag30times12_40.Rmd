...
saveRDS(data_col_importance, file.path('storage', 'data_col_importance_lag_36_lag30times12_40.rds'))
# data_col_importance <- readRDS(file.path('storage', 'data_col_importance_lag_36_lag30times12_40.rds'))
...
saveRDS(model_trained, file.path('storage', 'model_trained_36_lag30times12_40.rds'))
# model_trained <- readRDS(file.path('storage', 'model_trained_36_lag30times12_40.rds'))
...
saveRDS(out, file.path('storage', 'out_36_lag30times12_40.rds'))
# out <- readRDS(file.path('storage', 'out_36_lag30times12_40.rds'))
