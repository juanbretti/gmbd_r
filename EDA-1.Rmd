...
f_check_na(data_add)
```
> There are no missing values in the solar_dataset and station dataset. There are 3.6% NAs in the additional_dataset. The missing values will be imputed.
...
It's only being evaluated the first of the chunks, for simplification of the output.
